<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addNotice.aspx.cs" Inherits="uza_uza_addNotice" %>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <asp:TextBox ID="TextBox_title" runat="server" class="form-control mb-30" AutoComplete="off" name="notice title" placeholder="Enter Notice Title"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <asp:TextBox ID="TextBox_notice" runat="server" class="form-control mb-30" AutoComplete="off" name="notice" placeholder="Enter Notice"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="col-12">
                                    <asp:Button ID="Button_upload" runat="server" Text="Upload" class="btn uza-btn btn-3 mt-15" OnClick="Button_upload_Click"/>
                                </div>
                            </div>
                        </form>
                    </div>

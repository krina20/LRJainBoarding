<%@ Page Language="C#" AutoEventWireup="true" CodeFile="forgotPassword.aspx.cs" Inherits="uza_uza_forgotPassword" %>
					...
					<div class="classy-menu">
						...
						<div class="classynav">
							<ul id="Ul1">
								...
								<li><a href="updateDetails.aspx"> Update Detail </a></li>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										<asp:TextBox ID="TextBox_email" runat="server" class="form-control mb-30" AutoComplete="off" name="full-name" placeholder="Enter your Email-ID"></asp:TextBox>
								...
								<div class="col-12">
									<asp:Button ID="Button_sendMail" runat="server" Text="Send Mail !" class="btn uza-btn btn-3 mt-15" OnClick="Button_sendMail_Click"/>
								</div>

								<asp:Label ID="lblmsg" runat="server" class="col-form-label-lg"></asp:Label>
								<br /><br />
								<br /><br />

								<div class="col-12">
								<a href="studentLogin.aspx" class="btn uza-btn btn-3 mt-15"> Back to Login  </a> 
								</div>

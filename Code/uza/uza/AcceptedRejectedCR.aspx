<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AcceptedRejectedCR.aspx.cs" Inherits="uza_uza_AcceptedRejectedCR" %>
            ...
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcumb--con">
                        <h2 class="title"> Accepted Complaint/Request </h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Accepted Complaints/ Requests </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <form id="form1" runat="server">
                            <div class="row">
                                        ...
                                        <div class="form-group">
                                                 <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Height="309px" Width="526px">
                                ...
                                <br />
                                 ...
                                 <div class="form-group"> 
                                     <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="309px" Width="526px">
                                         <AlternatingRowStyle BackColor="White" />
                                         <EditRowStyle BackColor="#2461BF" />
                                         <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                         <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />

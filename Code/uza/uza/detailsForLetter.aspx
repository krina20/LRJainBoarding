<%@ Page Language="C#" AutoEventWireup="true" CodeFile="detailsForLetter.aspx.cs" Inherits="detailsForLetter" %>
            ...
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcumb--con">
                        <h2 class="title">Recommandation Letter</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Recommandation Letter</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <asp:TextBox ID="TextBox_name" runat="server" class="form-control mb-30" AutoComplete="off" placeholder="Enter student name"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="col-12">
                                    <asp:Button ID="Button_get" runat="server" Text="Get Letter" class="btn uza-btn btn-3 mt-15" OnClick="Button_get_Click"/>
                                </div>
                            </div>
                        </form>
                    </div>

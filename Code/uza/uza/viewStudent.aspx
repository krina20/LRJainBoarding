<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewStudent.aspx.cs" Inherits="uza_uza_viewStudent" %>
            ...
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcumb--con">
                        <h2 class="title">View Student Detail</h2>
            ...
            <div class="row justify-content-between">
               ...
               <div class="col-12 col-lg-8">
                    <div class="uza-contact-form mb-80">
                         <asp:Button ID="Button_viewAll" runat="server" Text="View All Students" class="btn uza-btn btn-2 mt-15" OnClick="Button_viewAll_Click" /><br />
                         <asp:Button ID="Button_viewRoomWise" runat="server" Text="View Students Room Wise" class="btn uza-btn btn-2 mt-15" OnClick="Button_viewRoomWise_Click" />

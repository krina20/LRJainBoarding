<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewNotice.aspx.cs" Inherits="uza_uza_scss_viewNotice" %>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" RepeatColumns="3" RepeatDirection="Horizontal" BorderStyle="None" BorderWidth="1px" CellPadding="4" BackColor="White" BorderColor="#3366CC" GridLines="Both">
                                        ...
                                        <br />
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LRJainBoardingConnectionString %>" SelectCommand="SELECT top 3 Title, Message FROM Notice"></asp:SqlDataSource>
                                        <br />
                                        <br /><br />
                                        <br /><br />
                            </div>

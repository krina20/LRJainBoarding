<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chart.aspx.cs" Inherits="uza_chart" %>
            ...
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcumb--con">
                        <h2 class="title">View Rooms Chart</h2>
                    ...
                    <div class="uza-contact-form mb-80">
                        <form id="form1" runat="server">
                            <div class="row">
                                ...
                                <asp:Button ID="Button1" runat="server" class="btn uza-btn btn-3 mt-15" OnClick="Button1_Click" Text="View" /><br />
                                </div>
                            <br /><br />
                                <div>

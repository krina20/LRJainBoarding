...
public partial class uza_uza_forgotPassword : System.Web.UI.Page
{
    ...
    protected void Button_sendMail_Click(object sender, EventArgs e)
    {
        ...
        string query = "select Email,Password from StudentReg where Email=@Email";
        ...
        if (sdr.Read())
        {
            ...
            mm.Subject = "Your Password of LRJainBoarding.com";

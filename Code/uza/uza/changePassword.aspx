<%@ Page Language="C#" AutoEventWireup="true" CodeFile="changePassword.aspx.cs" Inherits="uza_uza_changePassword" %>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <asp:TextBox ID="TextBox_old" runat="server" class="form-control mb-30" AutoComplete="off" name="Old Password" Textmode="Password" placeholder="Enter your old password"></asp:TextBox>
                                    </div>
                                </div>
                             </div>
                             ...
                             <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <asp:TextBox ID="TextBox_new" runat="server" class="form-control mb-30" AutoComplete="off" name="New Password" Textmode="Password" placeholder="Enter your new password"></asp:TextBox>         
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Password length must be between 5 to 10 characters" ControlToValidate="TextBox_new" ForeColor="Red" ValidationExpression="^[a-zA-Z0-9\s]{5,10}$"></asp:RegularExpressionValidator>
                                    </div>
                                </div>
                             </div>
                             ...
                             <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <asp:TextBox ID="TextBox_confirm_new" runat="server" class="form-control mb-30" Textmode="Password" AutoComplete="off" name="Confirm New Password" placeholder="Re-enter your new password"></asp:TextBox>
                                    </div>
                                </div>
                             </div>
                             <div class="row">
                                 <div class="col-12">
                                    <asp:Button ID="Button_pwd" runat="server" Text="Change" class="btn uza-btn btn-3 mt-15" OnClick="Button_pwd_Click"/>
                                </div>
                            </div>

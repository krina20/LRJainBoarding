<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewComplaintRequest.aspx.cs" Inherits="uza_uza_viewComplaintRequest" %>
			...
			<div class="row h-100 align-items-end">
				<div class="col-12">
					<div class="breadcumb--con">
						<h2 class="title">Complaints & Requests</h2>
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page"> Complaints & Requests </li>
							</ol>
						</nav>
					</div>
				</div>
							...
							<div class="row">
									...
									<center>
										<div class="col-12" style="text-align:center">  
											<table  style="width: 40%; height: 16px; margin-left: 160px; text-align:center;">
												<tr>
													<td class="col-form-label-lg"> <big> <b> <asp:Label ID="label1" runat="server" Text='<%#Eval("CR_details") %>'> </asp:Label> </b> </big> <br/><br/> </td>
									   
													<td class="col-12" style="text-align:center;  margin-left: 195px">
														<asp:Button ID="btnaccept" runat="server" Text="Accept" CommandName="Accept" class="btn uza-btn btn-2 mt-15" style="background-color:green;" CommandArgument='<%#Eval("Id") %>'/>
														<asp:Button ID="btndecline" runat="server" Text="Decline" CommandName="Decline"  class="btn uza-btn btn-2 mt-15" style="background-color:red;" CommandArgument='<%#Eval("Id") %>'/>
													</td>
											   </tr>
											 </table>   
										 </ItemTemplate>

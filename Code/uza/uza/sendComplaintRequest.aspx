<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sendComplaintRequest.aspx.cs" Inherits="uza_uza_sendComplaintRequest" %>
            ...
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcumb--con">
                        <h2 class="title">Send Complaints & Requests</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Send Complaints & Requests </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <form id="form1" runat="server">
                            <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                           <asp:TextBox ID="TextBox_message" runat="server" class="form-control mb-30" AutoComplete="off" name="Message" placeholder="Write your complaint/request here"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <asp:Button ID="Button_send" runat="server" Text="Send" class="btn uza-btn btn-3 mt-15" OnClick="Button_send_Click"/><br />

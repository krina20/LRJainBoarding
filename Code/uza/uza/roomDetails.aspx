<%@ Page Language="C#" AutoEventWireup="true" CodeFile="roomDetails.aspx.cs" Inherits="uza_uza_scss_roomDetails" %>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-form-label-lg">
                                         Hey <asp:Label ID="Label3" runat="server" Text=""></asp:Label>, <br />
                                        Your room no is 
                                        <b><asp:Label ID="Label1" runat="server" Text=""></asp:Label></b>
                                        and it is located on floor no.

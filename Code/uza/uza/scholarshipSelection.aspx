<%@ Page Language="C#" AutoEventWireup="true" CodeFile="scholarshipSelection.aspx.cs" Inherits="uza_uza_scholarshipSelection" %>
			...
			<div class="row h-100 align-items-end">
				<div class="col-12">
					<div class="breadcumb--con">
						<h2 class="title">Scholarship Selection</h2>
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page"> Scholarship Selection </li>
							</ol>
						</nav>
					</div>
				</div>
			   ...
			   <div class="col-12 col-lg-8">
					<div class="uza-contact-form mb-80">
						...
						<form id="form1" runat="server">
							<div class="row">
								<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  Width="1000px" OnRowCommand="GridView1_RowCommand">
								<Columns>
									<asp:TemplateField>
										<HeaderTemplate>
											<big>SCHOLARSHIP STUDENTS</big>
										</HeaderTemplate>
									<ItemTemplate>
										...
										<div class="col-12" style="text-align:center">
													...
													<asp:Label ID="label13" runat="server" Text='<%#Eval("Pcontact") %>'>   </asp:Label>
													<asp:Label ID="label14" runat="server" Text='<%#Eval("College") %>'>    </asp:Label>
													<asp:Label ID="label15" runat="server" Text='<%#Eval("Score") %>'>      </asp:Label>
													<asp:Label ID="label16" runat="server" Text='<%#Eval("Income") %>'>     </asp:Label>
												
													
														<asp:Button ID="Button1" runat="server" Text="Accept" class="btn uza-btn btn-3 mt-16" style="background-color:green;" CommandName="Accept" CommandArgument='<%#Eval("Id") %>'/> 
														<asp:Button ID="Button2" runat="server" Text="Decline" class="btn uza-btn btn-3 mt-17" style="background-color:red;" CommandName="Decline"  CommandArgument='<%#Eval("Id") %>'/>

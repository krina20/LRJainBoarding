<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userLogin.aspx.cs" Inherits="uza_uza_userLogin" %>
        ...
        <div class="main-header-area">
            <div class="classy-nav-container breakpoint-off">
                ...
                <nav class="classy-navbar justify-content-between" id="Nav1">
                    ...
                    <!-- Logo -->
                    <a class="nav-brand" href="#"><img src="./img/core-img/hostelLogo.png" width="60px" height="70px" alt=""></a>
                        ...
                        <div class="classynav">
                          <!--  <ul id="Ul1">
                            ...
                            <div class="get-a-quote ml-4 mr-3">
                                <a href="#" class="btn uza-btn"> Admin / Warden </a>
                            </div>   
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <asp:TextBox ID="TextBox_name" runat="server" class="form-control mb-30" AutoComplete="off" name="name" placeholder="Name"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter username first." ControlToValidate="TextBox_name" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </div>
                                </div>

                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <asp:TextBox ID="TextBox_password" runat="server" TextMode="Password" MaxLength="10" AutoComplete="off" class="form-control mb-30" name="password" placeholder="Password"></asp:TextBox>
                                ...
                                <div class="col-12">
                                    <asp:Button ID="login_btn" runat="server" Text="Login" class="btn uza-btn btn-3 mt-15" OnClick="login_btn_Click"/>
                                </div>
